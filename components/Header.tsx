...
export function Header() {
  ...
  return (
    <header
      className={`scroll-reactive-header sticky top-0 z-50 border-b border-border/70 bg-surface/90 shadow-[0_18px_60px_rgba(20,29,56,0.08)] backdrop-blur-xl will-change-transform ${
        headerVisible ? "opacity-100" : "pointer-events-none opacity-0 shadow-none"
      }`}
      style={{ transform: headerVisible ? "translate3d(0, 0, 0)" : "translate3d(0, -105%, 0)" }}
    >
